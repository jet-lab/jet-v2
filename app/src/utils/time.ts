...
export function unixToLocalTime(unixTimestamp: number) {
  const date = new Date(unixTimestamp * MS_PER_SECOND);
...
export function localDayMonthYear(unixTimestamp: number, preferDayMonthYear: boolean) {
  const date = new Date(unixTimestamp * MS_PER_SECOND);
...
export function utcDayMonthYear(unixTimestamp: number, preferDayMonthYear: boolean) {
  const date = new Date(unixTimestamp * MS_PER_SECOND);
