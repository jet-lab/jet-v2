            ...
            <div className="pie-chart-section-info flex align-start justify-center column">
              <div className="flex column">
                ...
                {poolsInit && currentPool ? (
                  <div className="pie-chart-section-info-item">
                    <Text type="success">
                      {currencyAbbrev(currentPool.vault.tokens, false, undefined, currentPool.decimals / 2)}
                    </Text>
              ...
              <div className="pie-chart-section-info flex column">
                ...
                {poolsInit && currentPool ? (
                  <div className="pie-chart-section-info-item">
                    <Text type="danger">
                      {currencyAbbrev(currentPool.borrowedTokens.tokens, false, undefined, currentPool.decimals / 2)}
                    </Text>
                    <Text>{currentPool?.symbol}</Text>
                  </div>
                ) : (
