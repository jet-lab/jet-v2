...
import { CurrentPath, TradeViewOrder } from '../../state/views/views';
...
import { animateViewOut, createDummyArray, getExplorerUrl } from '../../utils/ui';
...
export function PairRelatedAccount(): JSX.Element {
  const setCurrentPath = useSetRecoilState(CurrentPath);
  ...
  const balanceTableColumns = [
    ...
    },
    {
      ...
      render: (value: any, balance: AccountBalance) =>
        accountsInit && balance?.tokenSymbol ? (
          balance.overallBalance.uiTokens
        ) : (
