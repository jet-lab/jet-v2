...
export function WalkthroughModal(): JSX.Element {
  ...
  async function nextSection() {
    ...
    if (nextSection > 16 && pathname !== '/') {
      await changePage('/');
    } else if (nextSection > 12 && nextSection < 17 && pathname !== '/accounts') {
      await changePage('/accounts');
    } else if (nextSection > 9 && nextSection < 13 && pathname !== '/pools') {
      await changePage('/pools');
    } else if (nextSection > 2 && nextSection < 10 && pathname !== '/') {
      await changePage('/');
    }
