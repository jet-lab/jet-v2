export const IDL: JetMarginIDL = {
  ...
  instructions: [
      ...
      accounts: [
        {
          ...
          isMut: true,
          isSigner: true,
          docs: ["The authority that can register a lookup table for a margin account"]
        },
        {
          name: "payer",
          isMut: true,
        ...
        },
        {
          ...
          isMut: true,
          isSigner: false,
          docs: ["The margin account to create this lookup account for"]
        },
        {
          name: "registryAccount",
          isMut: true,
          isSigner: false,
          docs: ["The registry account"]
        },
        {
    ...
    },
    {
      ...
      docs: ["Create a lookup table in a registry account owned by a margin account."],
      accounts: [
        {
          name: "marginAuthority",
          isMut: true,
        ...
        },
        {
          ...
          isMut: true,
          isSigner: false,
          docs: ["The lookup table being created"]
        },
        {
    ...
    {
      name: "appendToLookup",
      docs: ["Append addresses to a lookup table in a registry account owned by a margin account."],
      accounts: [
        {
          name: "marginAuthority",
          isMut: true,
