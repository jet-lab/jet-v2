export type JetMarket = {
        ...
        },
        {
          ...
          accounts: [
            ...
            },
            {
              ...
              isMut: true
              isSigner: true
              docs: ["The account that must sign to redeem the ticket"]
            },
            {
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: "principal"
            docs: ["The total number of principal tokens the ticket was struck for"]
            type: "u64"
          },
          {
            name: "interest"
  ...
  types: [
    ...
    {
      name: "TicketKind"
      docs: ["Enum used for pattern matching a ticket deserialization"]
      type: {
        kind: "enum"
        variants: [
          {
