export type JetBonds = {
  ...
  instructions: [
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isMut: false;
          isSigner: false;
          docs: ["Token vault to recieve borrowed tokens"];
        },
        {
          name: "obligation";
          isMut: true;
    ...
    {
      name: "markDue";
      docs: ["Mark an `Obligation` as due"];
      accounts: [
        {
          name: "borrowerAccount";
          isMut: false;
        ...
        },
        {
          ...
          isMut: false;
          isSigner: false;
          docs: ["The `Obligation` account tracking debt"];
        }
      ];
      args: [];
    },
    ...
    {
      name: "borrowOrder";
      docs: ["Place a `Borrow` order to the book by burning tickets"];
      accounts: [
        {
          name: "user";
          isMut: false;
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          {
            name: "openOrders";
            docs: ["underlying token tied up in open orders"];
            type: "u64";
          },
          {
            name: "openTickets";
            docs: ["bond tickets tied up in `SplitTicket` structs"];
            type: "u64";
          }
        ];
      };
  ...
  events: [
    ...
    },
    {
      ...
      fields: [
        ...
        {
          name: "obligationTimestamp";
          type: "i64";
          index: false;
        },
        {
          name: "markedDueTimestamp";
          type: "i64";
          index: false;
        }
      ];
