use jet_instructions::{
    ...
    margin::{TokenAdmin, TokenConfigUpdate, TokenKind, derive_token_config},
...
use super::{Builder, BuilderError, TokenContext, LookupScope};
...
pub(crate) async fn configure_for_token(
    ...
    builder.register_lookups(LookupScope::Pools, [
        pool_ix.address,
        pool_ix.vault,
        pool_ix.deposit_note_mint,
        pool_ix.loan_note_mint,
