export type JetMarket = {
  ...
  "accounts": [
      ...
      "type": {
        ...
        "fields": [
          ...
          },
          {
            ...
            "type": "u8" // do not change
          }
        ]
      }
    },
    {
      "name": "EventAdapterMetadata", // do not change
      "type": {
        "kind": "struct",
        "fields": [
          {
    ...
    {
      "name": "SplitTicket", // do not change
      "docs": [
...
export const IDL: JetMarket = {
  ...
  "accounts": [
    ...
    {
      "name": "CrankAuthorization", // do not change
      "docs": [
        "This authorizes a crank to act on any orderbook within the airspace"
      ],
      "type": {
