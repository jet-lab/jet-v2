...
import { feesBuffer, Pool } from "./pool/pool";
import { AccountPositionListLayout, AdapterPositionFlags, ErrorCode, PositionKind } from "./state";
import { findDerivedAccount } from "../utils/pda";
import { AssociatedToken, bigIntToBn, bnToNumber, getTimestamp, Number192, numberToBn, sendAll, sendAndConfirm, TokenAmount } from "..";
...
MarginAccount.SETUP_LEVERAGE_FRACTION = Number128.fromDecimal(new BN(50), -2);
