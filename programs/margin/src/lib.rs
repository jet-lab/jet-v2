...
/// The maximum amount of equity that can be deducted from an account during liquidation as a
/// proportion of the total dollar value that needed to be collateralized at the start of liquidation.
